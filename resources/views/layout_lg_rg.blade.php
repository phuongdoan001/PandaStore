...
<head>
    ...
    <link rel="SHORTCUT ICON" href="storage/app/admin/tdjGLLlHOjrheI98wB0ew7Q07aSRAUSEddq7lI4Y.jpeg">
        ...
        <div class="container-fluid border-bottom">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto"> 
                    ...
                    <li class="nav-item">
                        <a href="{{URL::to('about-us')}}" class="nav-link"><span class="fas fa-list-alt"></span> Về Chúng Tôi</a>
                    </li>
                    <?php 
                        $id     = Session::get('id');
