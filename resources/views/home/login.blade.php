...
@section('content')
 <div class="container-fluid" style="height: 350px; background-image: url(storage/app/public/113.jpg);">
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="card" style="margin-top: 40px;">
                        <div class="card-header bg-primary text-white">{{ __('Đăng Nhập') }}</div>
